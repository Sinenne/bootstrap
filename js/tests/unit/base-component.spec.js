  ...
  describe('Static Methods', () => {
    ...
    describe('NAME', () => {
      ...
      it('should return plugin NAME', () => {
        expect(DummyClass.NAME).toBe(name)
      })
    })
  ...
  describe('Public Methods', () => {
    describe('constructor', () => {
      it('should accept element, either passed as a CSS selector or DOM element', () => {
        ...
        expect(elInstance._element).toBe(el)
        expect(selectorInstance._element).toBe(fixtureEl.querySelector('#bar'))
      })
    ...
    describe('getInstance', () => {
      ...
      it('should accept element, either passed as a CSS selector, jQuery element, or DOM element', () => {
        ...
        expect(DummyClass.getInstance(fakejQueryObject)).toBe(instance)
      })
    ...
    describe('getOrCreateInstance', () => {
      it('should return an instance', () => {
        ...
        expect(DummyClass.getInstance(element)).toBe(DummyClass.getOrCreateInstance(element, {}))
